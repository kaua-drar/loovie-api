/*
  ...
  - The primary key for the `MediaTranslation` table will be changed. If it partially fails, the table could be left without primary key constraint.
  - You are about to drop the column `id` on the `MediaTranslation` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "MediaTranslation" DROP CONSTRAINT "MediaTranslation_pkey",
DROP COLUMN "id",
ADD CONSTRAINT "MediaTranslation_pkey" PRIMARY KEY ("media_id", "language_code");
